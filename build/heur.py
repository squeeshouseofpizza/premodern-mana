...
H = {
 ...
 "Reflecting Pool": (1, "union of the colours of the other lands in the decklist", "One mana, and colour identity borrowed from the rest of the mana base. Produces nothing if it is the only mana-producing land you control."),
 ...
 "Bad River": (1, "colours of the Island and Swamp cards in the decklist", "Counts as a source of whatever it can actually find in this deck. Zero for a colour with no fetchable land."),
 "Flood Plain": (1, "colours of the Plains and Island cards in the decklist", "See Bad River."),
 "Grasslands": (1, "colours of the Forest and Plains cards in the decklist", "See Bad River."),
 "Mountain Valley": (1, "colours of the Mountain and Forest cards in the decklist", "See Bad River."),
 "Rocky Tar Pit": (1, "colours of the Swamp and Mountain cards in the decklist", "See Bad River."),
 ...
 "Terrain Generator": (1, "colourless", "Count only its own colourless mana. The basic it deploys should be counted as that basic, not as extra output from this card."),
 "Meteor Crater": (1, "colours of your own non-land permanents once a board exists", "Zero with only lands on the battlefield, since lands are colourless. Cannot cast your first spell, only later ones in a colour you already have out."),
 "Terminal Moraine": (1, "colourless", "Count only its own colourless mana. The basic it fetches should be counted as that basic, not as extra output from this card."),
 ...
 "Bloodstained Mire": (1, "colours of the Swamp and Mountain cards in the decklist", "Counts as a source of whatever it can actually find in this deck. Zero for a colour with no fetchable land. Costs 1 life and can be cracked the turn it is played."),
 "Flooded Strand": (1, "colours of the Plains and Island cards in the decklist", "See Bloodstained Mire."),
 "Polluted Delta": (1, "colours of the Island and Swamp cards in the decklist", "See Bloodstained Mire."),
 "Windswept Heath": (1, "colours of the Forest and Plains cards in the decklist", "See Bloodstained Mire."),
 "Wooded Foothills": (1, "colours of the Mountain and Forest cards in the decklist", "See Bloodstained Mire."),
}
